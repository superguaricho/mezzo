...
-- | Multiply two type-level naturals.
...
instance
    (TypeError (Text "Can't have a " :<>: Text s :<>: Text " in minor mode.")) =>
...
type family FromProg (p :: ProgType k l) (t :: TimeSignature) :: Partiture 4 (Mul (Mul l t) 8) where
